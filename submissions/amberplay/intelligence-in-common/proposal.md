...
### 策略比选：为什么不选“展示带”或“三个孤立测试园”

| 策略 | 公共日常性 | 场地契合 | 失败可恢复 | 三区协同 | 跨城复制 | 结论 |
|---|---:|---:|---:|---:|---:|---|
| A 科技展示带 | 2 | 3 | 2 | 2 | 2 | 节庆可见，但易把市民变成观众 |
| B 三个独立测试园 | 1 | 2 | 3 | 1 | 2 | 专业可控，但切断公共主脊与日常生活 |
| **C PASS 公共验收城市** | **5** | **5** | **5** | **5** | **5** | **普通城市永久，AI 插件限时；入场证据可跨城传递** |

表中 1—5 是设计团队为方案比选设定的定性序位，不是现状测量、专家评分或政府结论。C 胜出的关键不是得分，而是它同时回答了“公共空间怎样更好”与“AI 失败时城市怎样照常运行”。
