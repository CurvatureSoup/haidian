...
方案不是从一张“空白场地”开始。官方公开信息显示，知春路至清华东路约2.5公里的遗址公园一期已于2023年开放，保留铁轨与桥梁记忆，并形成雨水设施、桥下活动和东西缝合的现实基底。v0.3因此不在一期范围重复制造景观概念，而把六门核验、无障碍连续、责任界面和运营回执叠加为既有公共资产的审计与服务层。[source:JINGZHANG-PHASE1-OPEN-2023]
...
2021年官方规划解读已识别全线断点、多元权属与分期实施难题，并提出总师/责任工程师、沿线“城市合伙人”和全过程共建共治机制。v0.3把这些既有机制转译为工作包牵头角色、专业验收、季度回执和退出决策，但不声称任何机构已接受本方案角色。当前仍缺最终批准文本与可复用GIS/CAD，所有提交边界、重点区和面积继续保持 provisional。[source:JINGZHANG-PLAN-INTERPRETATION-2021]
